/*
  ...
  - You are about to alter the column `userId` on the `courses` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  ...
  - You are about to alter the column `id` on the `feedbacks` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `meetingIds` on the `feedbacks` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `userId` on the `feedbacks` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  ...
  - You are about to alter the column `id` on the `meetings` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `observationIds` on the `meetings` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  ...
  - You are about to alter the column `userId` on the `messages` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  ...
  - You are about to alter the column `id` on the `observations` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `courseId` on the `observations` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `userId` on the `observations` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  ...
  - You are about to alter the column `id` on the `obsrequests` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `courseId` on the `obsrequests` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `userId` on the `obsrequests` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
...
ALTER TABLE `feedbacks` DROP PRIMARY KEY,
    MODIFY `id` INTEGER NOT NULL AUTO_INCREMENT,
    MODIFY `meetingIds` INTEGER NOT NULL,
    MODIFY `userId` INTEGER NOT NULL,
    ADD PRIMARY KEY (`id`);
...
ALTER TABLE `meetings` DROP PRIMARY KEY,
    MODIFY `id` INTEGER NOT NULL AUTO_INCREMENT,
    MODIFY `observationIds` INTEGER NOT NULL,
    ADD PRIMARY KEY (`id`);
